Shader "AllIn13DShader/AllIn13DShaderOutline_NoShadowCaster"
{
	Properties
	{
		...
		*/
		...
		//Receive Shadows
		[Effect(EffectID# RECEIVE_SHADOWS, GroupID# Lighting)][Toggle(_RECEIVE_SHADOWS_ON)]_ReceiveShadows("Receive Shadows", Float) = 1.0
